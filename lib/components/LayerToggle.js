...
LayerToggle = function (_Component) {_inherits(LayerToggle, _Component);
  ...
  function LayerToggle(props, context) {_classCallCheck(this, LayerToggle);var _this = _possibleConstructorReturn(this, (LayerToggle.__proto__ || Object.getPrototypeOf(LayerToggle)).call(this,
    ...
    {var _props =
      ...
      this.layerStore;var _show = _layerStore.show;var _hide = _layerStore.hide;
      ...
      return children.apply(undefined, [{
        ...
        hide: function hide() {var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;return props.for ? _hide(props.for) : _hide(id);},
        toggle: function toggle(_id) {
          var id = props.for ? props.for : _id;
          stack.indexOf(props.for) !== -1 ? _hide(id) : _show(id);
        },
        reset: function (_reset) {function reset(_x2) {return _reset.apply(this, arguments);}reset.toString = function () {return _reset.toString();};return reset;}(function (id) {return props.for ? reset(props.for) : reset(id);}) }].concat(_toConsumableArray(
