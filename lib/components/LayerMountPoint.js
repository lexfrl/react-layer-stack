...
LayerMountPoint = function (_Component) {_inherits(LayerMountPoint, _Component);
  ...
  function LayerMountPoint(props, context) {_classCallCheck(this, LayerMountPoint);var _this = _possibleConstructorReturn(this, (LayerMountPoint.__proto__ || Object.getPrototypeOf(LayerMountPoint)).call(this,
    ...
    {var
      id = this.props.id;var _layerStore =
      this.layerStore;var _show = _layerStore.show;var _hide = _layerStore.hide;var _update = _layerStore.update;var _reset = _layerStore.reset;var isActive = _layerStore.isActive;
      var stack = this.layerStore.getStack();
      var layer = this.layerStore.getLayer(id);
      var index = this.layerStore.getIndex(id);
      return isActive(id) ? layer.layerFn.apply(layer, [{
        ...
        update: function update() {for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}return _update(id, args);},
        reset: function reset() {return _reset(id);} }].concat(_toConsumableArray(
      layer.args))) : null;
