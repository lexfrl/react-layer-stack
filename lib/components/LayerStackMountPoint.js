...
LayerStackMountPoint = function (_Component) {_inherits(LayerStackMountPoint, _Component);
  ...
  function LayerStackMountPoint(props, context) {_classCallCheck(this, LayerStackMountPoint);var _this = _possibleConstructorReturn(this, (LayerStackMountPoint.__proto__ || Object.getPrototypeOf(LayerStackMountPoint)).call(this,
    ...
    {var _props =
      this.props,mountPointId = _props.id,elementType = _props.elementType,wrapperClass = _props.wrapperClass,wrapperActiveClass = _props.wrapperActiveClass,layerItemClass = _props.layerItemClass;
      var layersForMountPoint = this.layerStore.getLayersForMountPoint(mountPointId);
      var wrapperClassName = wrapperClass ? wrapperClass + (layersForMountPoint.length ? ' ' + wrapperActiveClass : '') : '';
      return (0, _react.createElement)(elementType, { className: wrapperClassName }, this.layerStore.getLayersForMountPoint(mountPointId).
      map(function (id) {return (0, _react.createElement)(elementType, { key: id, className: layerItemClass },
