...
LayerStackMountPoint = function (_Component) {_inherits(LayerStackMountPoint, _Component);
  ...
  function LayerStackMountPoint(props, context) {_classCallCheck(this, LayerStackMountPoint);var _this = _possibleConstructorReturn(this, (LayerStackMountPoint.__proto__ || Object.getPrototypeOf(LayerStackMountPoint)).call(this,
    ...
    {var _props =
      this.props,mountPointId = _props.id,elementType = _props.elementType,layerStackWrapperClass = _props.layerStackWrapperClass,layerWrapperClass = _props.layerWrapperClass;
      return (0, _react.createElement)(elementType, { className: layerStackWrapperClass }, this.layerStore.getLayersForMountPoint(mountPointId).
      map(function (id) {return (0, _react.createElement)(elementType, { key: id, className: layerWrapperClass },
