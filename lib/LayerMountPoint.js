...
LayerMountPoint = function (_Component) {_inherits(LayerMountPoint, _Component);
  ...
  function LayerMountPoint(props, context) {_classCallCheck(this, LayerMountPoint);var _this = _possibleConstructorReturn(this, (LayerMountPoint.__proto__ || Object.getPrototypeOf(LayerMountPoint)).call(this,
  ...
  }_createClass(LayerMountPoint, [{ key: 'componentWillUnmount', value: function componentWillUnmount()
    ...
    {var _props =
      ...
      this.layerStore;var _show = _layerStore.show;var _hide = _layerStore.hide;var _setArgs = _layerStore.setArgs;var isActive = _layerStore.isActive;
      ...
      return isActive(id) ? layer.layerFn.apply(layer, [{
        ...
        setArgs: function setArgs() {for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}return _setArgs(id, args);} }].concat(_toConsumableArray(
      layer.args))) : null;
