...
var LayerStackMountPoint = exports.LayerStackMountPoint = function LayerStackMountPoint() {var namespace = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'layer_stack';return (0, _reactRedux.connect)(
  ...
  function (_ref) {var mountPointId = _ref.id;var mountPointArgs = _ref.args;var renderFn = _ref.renderFn;var views = _ref.views;var displaying = _ref.displaying;var show = _ref.show;var hide = _ref.hide;var hideAll = _ref.hideAll; // from store
    return (
            ...
            _react2.default.createElement('div', { key: id },
              function () {
                ...
                if (view && view.renderFn && view.mountPointId === mountPointId) {
                  return view.renderFn.apply(view, [{ // TODO: check that renderFn is a function
