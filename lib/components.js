...
var LayerStackMountPoint = exports.LayerStackMountPoint = function LayerStackMountPoint() {var namespace = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'layer_stack';return (0, _reactRedux.connect)(
  ...
  function (_ref) {var renderFn = _ref.renderFn;var mountPointArgs = _ref.args;var views = _ref.views;var displaying = _ref.displaying;var show = _ref.show;var hide = _ref.hide;var hideAll = _ref.hideAll; // from store
    return (
      _react2.default.createElement('div', null, ' ', renderFn ? renderFn({ views: views, displaying: displaying, show: show, hide: hide, hideAll: hideAll }) // it's possible to provide alternative renderFn for the MountPoint
              ...
              function () {
                if (views[id] && views[id].renderFn) {var _views$id;
                  return (_views$id = views[id]).renderFn.apply(_views$id, [{ // TODO: check that renderFn is a function
                    index: index, id: id, show: show, hide: hide, hideAll: hideAll, displaying: displaying, views: views, mountPointArgs: mountPointArgs,
